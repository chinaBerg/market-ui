...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_maps__ = __webpack_require__(164);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    tipItemClassName: function tipItemClassName(item) {
      ...
      return [TIPS + '__item', (_ref = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, TIPS + '--info', item.type === 'info'), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, TIPS + '--error', item.type === 'error'), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, TIPS + '--success', item.type === 'success'), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, TIPS + '--warning', item.type === 'warning'), _ref)];
    },
    ...
    add: function add(type) {
      ...
      config.type = type;
      config.icon = __WEBPACK_IMPORTED_MODULE_2__utils_maps__["a" /* baseType2Icons */][type];
      config._ulid = Object(__WEBPACK_IMPORTED_MODULE_3__utils_assist__["a" /* createULID */])();

      // 创建
      this.tips.push(config);
      Object(__WEBPACK_IMPORTED_MODULE_3__utils_assist__["h" /* isFunction */])(config.onShow) && config.onShow();
    ...
    remove: function remove(config) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_3__utils_assist__["h" /* isFunction */])(config.onClose) && config.onClose();
      this.$emit('closed');
    }
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_tip__ = __webpack_require__(163);
...
var init = function init() {
  ...
  var vueIns = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    render: function render(h) {
      return h(__WEBPACK_IMPORTED_MODULE_1__src_tip__["a" /* default */], { props: props });
    }
  });
...
__WEBPACK_IMPORTED_MODULE_1__src_tip__["a" /* default */].init = init;

/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_1__src_tip__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_tip_vue__ = __webpack_require__(141);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_3a1af660_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_tip_vue__ = __webpack_require__(165);
var disposed = false
var normalizeComponent = __webpack_require__(17)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_tip_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_3a1af660_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_tip_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a1af660", Component.options)
  } else {
    hotAPI.reload("data-v-3a1af660", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return baseType2Icons; });
var baseType2Icons = {
  info: 'tip',
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-3a1af660", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tip__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_assist__ = __webpack_require__(28);




var messageSingle = Object(__WEBPACK_IMPORTED_MODULE_2__utils_assist__["m" /* singlePattern */])(__WEBPACK_IMPORTED_MODULE_1__tip__["a" /* default */].init);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  message: function message(type, config) {
    if (!Object(__WEBPACK_IMPORTED_MODULE_2__utils_assist__["j" /* isObject */])(config)) {
      config = {
        title: config
      };
    }
    ...
    var params = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(defaultConfig, config);
