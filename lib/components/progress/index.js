...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__side__ = __webpack_require__(265);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'MkuProgress',
  components: { ProgressSide: __WEBPACK_IMPORTED_MODULE_3__side__["a" /* default */] },
  props: {
    // 绑定的值
    percent: {
      type: Number,
  ...
  computed: {
    ...
    progressClasss: function progressClasss() {
      ...
      var eq = function eq(v) {
        return Object(__WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* isEqual */])(_this.status, v);
      };
      return [prefix, (_ref = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--success', eq('success') || isFinish), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--error', eq('error') && !isFinish), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--warning', eq('warning') && !isFinish), _ref)];
    },
    ...
    shadowClasss: function shadowClasss() {
      ...
      var eq = function eq(v) {
        return Object(__WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* isEqual */])(_this2.activeAnimate, v);
      };
      return [prefix, (_ref2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref2, prefix + '--line', eq('line') && isActive), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref2, prefix + '--zebra', eq('zebra') && isActive), _ref2)];
    },
    ...
    outerStyle: function outerStyle() {
      ...
      if (bg) {
        if (Object(__WEBPACK_IMPORTED_MODULE_2__utils_assist__["f" /* isArray */])(bg)) {
    ...
    innerStyle: function innerStyle() {
      ...
      var cor = this.color;
      if (cor) {
        if (Object(__WEBPACK_IMPORTED_MODULE_2__utils_assist__["f" /* isArray */])(cor)) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    sideClasss: function sideClasss() {
      ...
      var eq = function eq(v) {
        return Object(__WEBPACK_IMPORTED_MODULE_2__utils_tools__["e" /* isEqual */])(_this.$parent.textPlacement, v);
      };
      return [prefix, (_ref = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--start', eq('start')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--end', eq('end')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--start-inside', eq('start-inside')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--end-inside', eq('end-inside')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref, prefix + '--top-follow', eq('top-follow')), _ref)];
    },
    ...
    iconClasss: function iconClasss() {
      ...
      var prefix = 'mku-icon';
      var eq = function eq(v) {
        return Object(__WEBPACK_IMPORTED_MODULE_2__utils_tools__["e" /* isEqual */])(_this2.status, v);
      };
      return [prefix, 'mku-progress__icon', (_ref2 = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref2, prefix + '-success', eq('success')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref2, prefix + '-error-circle', eq('error')), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ref2, prefix + '-warning', eq('warning')), _ref2)];
    }
  },
  render: function render(h) {
    var _$parent = this.$parent,
        textRender = _$parent.textRender,
        calcPercent = _$parent.calcPercent;

    if (textRender && Object(__WEBPACK_IMPORTED_MODULE_1__utils_assist__["h" /* isFunction */])(textRender)) {
      return textRender(h, calcPercent);
    }
    var Icon = h('i', { class: this.iconClasss });
    return h('div', { class: this.sideClasss }, [this.status === 'active' ? calcPercent + '%' : Icon]);
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_progress__ = __webpack_require__(264);


__WEBPACK_IMPORTED_MODULE_0__src_progress__["a" /* default */].install = function (Vue) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_progress_vue__ = __webpack_require__(184);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_29baf907_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_progress_vue__ = __webpack_require__(266);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_29baf907_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_progress_vue__["a" /* default */],
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-29baf907", Component.options)
  } else {
    hotAPI.reload("data-v-29baf907", Component.options)
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_side_vue__ = __webpack_require__(185);
/* unused harmony namespace reexport */
var disposed = false
var normalizeComponent = __webpack_require__(17)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_side_vue__["a" /* default */],
  __vue_template__,
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-527a2031", Component.options)
  } else {
    hotAPI.reload("data-v-527a2031", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-29baf907", esExports)
  }
}
